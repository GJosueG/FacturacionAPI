...
namespace FacturacionAPI.Endpoints
{
    public static class EstadoEndpoints
    {
        ...
        {
            var group = routes.MapGroup("/api/estados").WithTags("Estados");

            group.MapGet("/", async (IEstadoServices estadoServices) =>
            {
            ...
            group.MapGet("/{id}", async (int id, IEstadoServices estadoServices) => {
            ...
            group.MapPost("/", async (EstadoRequest estado, IEstadoServices estadoServices) => {
                if (estado == null)
            ...
            group.MapPut("/{id}", async (int id, EstadoRequest estado, IEstadoServices estadoServices) => {
            ...
            group.MapDelete("/{id}", async (int id, IEstadoServices estadoServices) => {
