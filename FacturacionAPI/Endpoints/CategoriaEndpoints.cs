...
namespace FacturacionAPI.Endpoints
{
    public static class CategoriaEndpoints
    {
        ...
        public static void Add(this IEndpointRouteBuilder routes)
        {
            ...
            group.MapGet("/", async (ICategoriaServices categoriaServices) =>
            {
            ...
            group.MapGet("/{id}", async (int id, ICategoriaServices categoriaServices) => {
            ...
            group.MapPost("/", async (CategoriaRequest categoria, ICategoriaServices categoriaServices) => {
                if (categoria == null)
            ...
            group.MapPut("/{id}", async (int id, CategoriaRequest categoria, ICategoriaServices categoriaServices) => {
            ...
            group.MapDelete("/{id}", async (int id, ICategoriaServices categoriaServices) => {
